...
%\footnote{
%  In 2020, less than 40\% of the admitted students are high-school graduates.
...
%  If I assume that that this number corresponds to the share of high-school students whose hometowns are in different prefectures, I obtain a rough estimate of the share of the high-school graduates whose high schools and hometowns are in different prefectures as $0.40 * 0.039 = 1.6\%$. 
%}
...
Since neighboring prefectures are geographically close, I consider that this measurement error is not large.
...
(ii) snowfall before the exams cumulates snow on the ground and students' performance is affected by the cumulated snow on the exam dates.
